...
$lang = array_merge($lang, array(
	...
	'REMOVE_GARAGE_INSTALL'	=> 'Please delete, move or rename the garage install directory before you use your garage. If this directory is still present the garage will be unavailable',
