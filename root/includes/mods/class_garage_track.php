	...
	function show_toplap()
	{
		...
		for ($i = 0; $i < count($laps); $i++)
		{
			$template->assign_block_vars($template_block_row, array(
				'U_COLUMN_1' 		=> append_sid("{$phpbb_root_path}garage/garage_vehicle.$phpEx", "mode=view_vehicle&amp;VID=".$laps[$i]['vid']),
				'U_COLUMN_2' 		=> append_sid("{$phpbb_root_path}{$phpbb_root_path}garage/garage_track.$phpEx", "mode=view_track&amp;VID=".$laps[$i]['vid']."&amp;TID=".$laps[$i]['tid']),
				'U_COLUMN_3' 		=> append_sid("{$phpbb_root_path}{$phpbb_root_path}garage/garage_track.$phpEx", "mode=view_lap&amp;VID=".$laps[$i]['vid']."&amp;LID=".$laps[$i]['lid']),
